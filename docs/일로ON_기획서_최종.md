...
| ID | 요구사항 | 우선순위 |
|---|---|---|
| REQ-01 | 사용자 회원가입 | Must |
| REQ-03 | 사용자 로그인 | Must |
| REQ-03 | 프로젝트 생성/조회 | Must |
| REQ-04 | 프로젝트별 Task 관리 | Must |
| REQ-05 | Task 담당자/마감일/상태 관리 | Must |
| REQ-06 | 프로젝트별 회의 생성/조회 | Must |
| REQ-07 | 회의록 작성/조회 | Must |
| REQ-08 | AI 회의 요약 | Must |
| REQ-09 | AI Action Point 추출 | Must |
| REQ-10 | Action Point 검토/수정 | Must |
| REQ-11 | Action Point → Task 등록 | Must |
| REQ-12 | 관련 회의 조회 | Must |
| REQ-13 | My Tasks | Must |
| REQ-14 | Team Tasks | Should |
| REQ-15 | Calendar | Should |
| REQ-16 | 알림 | Could |
| REQ-17 | Sprint 생성/관리 | Must |
| REQ-18 | Task → Sprint 배정 | Must |
| REQ-19 | 프로젝트 팀원 초대 | Must |
| REQ-20 | 메신저 텍스트 입력 | Must |
| REQ-21 | 회의 녹음본 업로드 | Must |
| REQ-22 | 녹음본 STT 변환 | Must |
